    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FridgeUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FridgeUsers_Fridges_FridgeId",
                        column: x => x.FridgeId,
                        principalTable: "Fridges",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FridgeUsers_AppUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AppUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FridgeIngredients", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FridgeIngredients_FridgeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FridgeUsers_FridgeId",
                table: "FridgeUsers",
                column: "FridgeId");

            migrationBuilder.CreateIndex(
                name: "IX_FridgeUsers_UserId",
                table: "FridgeUsers",
                column: "UserId");
